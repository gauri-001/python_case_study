...
class faculty(employee):
    def __init__(self, name, dep, dob, id, sal, sub, no_rsp, qual):
        super().__init__(name, dep, dob, id, sal)
        self.sub = sub
        self.no_rsp = no_rsp
        self.qual = qual
...
l1 = lab_assistant("Yogita Deskmukh", "Computer",
                   "13/4/1982", "3035", 20000, "OS")
l2 = lab_assistant("Kush Patil", "Computer",
                   "23/7/1985", "3482", 18000, "Python")
l3 = lab_assistant("Pushpak Patel", "Computer",
                   "4/12/1985", "3062", 19000, "DAA")

lab = [l1, l2, l3]

f1 = faculty("Kalpesh lodha", "Computer", "13/5/1978",
             "5411", 90000, "OS\t", 5, "PhD")
f2 = faculty("Pranav Patil","Computer", "27/6/1981",
             "2465", 70000, "Python", 4, "M.Tech")
f3 = faculty("Kalyani Ghosh", "Computer", "16/1/1988",
             "1254", 60000, "DAA\t", 3, "M.Tech")

fac = [f1, f2, f3]

s1 = student("Ruchi Shah", "Computer", "7/2/2003",
             "2130331245000", "1st", 8.77)
s2 = student("Tushar Shroff", "Computer", "26/8/2002",
             "2030331245034", "2nd", 9.67)
s3 = student("Arun Dhar", "Computer", "15/4/2001",
