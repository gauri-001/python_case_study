...
query = """CREATE TABLE student_tbl(PRN VARCHAR(20),FNAME VARCHAR(10),
MNAME VARCHAR(10),LNAME VARCHAR(20),ADDR VARCHAR(20),
MOB VARCHAR(20),EMAIL VARCHAR(20),AGE VARCHAR(20))"""
...
sql = "UPDATE student_tbl SET MOB = '8937482359', EMAIL ='nakshbirla@gmail.com' WHERE PRN = 1245058"
cursor.execute(sql)
conn.commit()
